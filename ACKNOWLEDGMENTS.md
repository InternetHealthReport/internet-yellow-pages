...
We use the free [IP-to-country](https://ipinfo.io/products/free-ip-database) mapping provided by [IPinfo](https://ipinfo.io) and released the under [Creative Commons Attribution-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-sa/4.0/).
