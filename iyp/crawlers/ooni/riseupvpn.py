...
class Crawler(OoniCrawler):
    ...
    def process_one_line(self, one_line):
        ...
        api_failures = one_line['test_keys'].get('api_failures')
    ...
    def batch_add_to_iyp(self):
        ...
        riseupvpn_id = self.iyp.get_node('Tag', {'label': label}, create=True)
        ...
        for (asn, country), result_dict in self.all_percentages.items():
            ...
            censored_links.append(
                {'src_id': asn_id, 'dst_id': riseupvpn_id, 'props': [props, self.reference]}
            )
