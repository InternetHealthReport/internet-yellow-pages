...
class Crawler(OoniCrawler):
    ...
    def __init__(self, organization, url, name):
        super().__init__(organization, url, name, 'psiphon')
    ...
    def batch_add_to_iyp(self):
        ...
        for asn, country, result in self.all_results:
            ...
            if asn_id and country_id:
                ...
                link_properties[(asn_id, psiphon_id)] = props

        for (asn_id, psiphon_id), props in link_properties.items():
            if (asn_id, psiphon_id) not in self.unique_links['CENSORED']:
                self.unique_links['CENSORED'].add((asn_id, psiphon_id))
